...
class Crawler(object):
 ...
 def __init__(self):
    ...
    print str(sys.argv)
    if len(sys.argv) == 1:
        self.doc_page = "https://aws.amazon.com/"
        self.doc_filter = "https://aws.amazon.com/"
    elif len(sys.argv) == 2:
 ...
 def open(self):
    ...
    try:
        ...
        response = opener.open(self.current_page)
 ...
 def download(self):
    for html_page in self.visited_links:
        ...
        html_name = 'largeSet/' + '_'.join(html_page) + '.html'
        f1 = open(html_name, 'w+')
 ...
 def run(self):
    ...
    while len(self.visited_links) <= 10:
        self.open()
