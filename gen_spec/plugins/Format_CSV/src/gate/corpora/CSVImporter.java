...
public class CSVImporter extends ResourceHelper {
   ...
   *          separator (usually ")
   * @param nameColumn
   *          the (zero index based) column which contains the document name to use. If this is
   *          less than 0 then the default name GATE assigns to a new document is used instead.
